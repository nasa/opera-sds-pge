...
class DswxS1PgeTestCase(unittest.TestCase):
    ...
    def _compare_algorithm_parameters_runconfig_to_expected(self, runconfig):
        ...
        self.assertListEqual(runconfig['processing']['initial_threshold']['threshold_bounds']['co_pol'], [-28, -8])
        self.assertListEqual(runconfig['processing']['initial_threshold']['threshold_bounds']['cross_pol'], [-28, -14])

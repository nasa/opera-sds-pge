...
class MetadataUtilsTestCase(unittest.TestCase):
    ...
    def test_get_cslc_s1_product_metadata(self):
        ...
        try:
            ...
            self.assertEqual(product_metadata['data']['x_coordinates'], "key x_coordinates is in ignore-keys list")
            self.assertEqual(product_metadata['data']['y_coordinates'], "key y_coordinates is in ignore-keys list")

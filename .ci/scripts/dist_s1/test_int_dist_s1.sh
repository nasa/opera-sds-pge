...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="dist_s1_final_2.0.11_expected_input.zip "
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="dist_s1_final_2.0.11_expected_output.zip "
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_dist_s1_r4.7_final_runconfig.yaml"
...
algo_runconfig="opera_pge_dist_s1_r4.7_final_algorithm_parameters.yaml"

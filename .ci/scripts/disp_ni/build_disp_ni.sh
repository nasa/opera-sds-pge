...
[ -z "${TAG}" ] && TAG="${USER}-dev"
[ -z "${SAS_IMAGE}" ] && SAS_IMAGE="artifactory-fn.jpl.nasa.gov:16001/gov/nasa/jpl/opera/adt/opera-adt/disp-nisar:v0.3.1"
...
mkdir -p ${STAGING_DIR}/opera/pge/disp_s1; cp -r ${WORKSPACE}/src/opera/pge/disp_s1/disp_s1_pge.py ${STAGING_DIR}/opera/pge/disp_s1/

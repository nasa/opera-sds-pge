...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="disp_ni_interface_0.1.1_expected_input.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="disp_ni_interface_0.1.1_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_disp_ni_r1.0_interface_runconfig_historical.yaml"
...
historical_runconfig="opera_pge_disp_ni_r1.0_interface_runconfig_historical.yaml"
...
do
    ...
    algo_runconfig="opera_pge_disp_ni_r1.0_interface_algorithm_parameters_${mode}.yaml"
    ...
    docker run --rm -u $UID:"$(id -g)" --name $container_name \
               ...
               ${PGE_IMAGE}:"${PGE_TAG}" --file /home/mamba/runconfig/opera_pge_disp_ni_r1.0_interface_runconfig_${mode}.yaml

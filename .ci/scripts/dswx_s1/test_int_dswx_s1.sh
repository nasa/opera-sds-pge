...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="dswx_s1_final_1.2_expected_input.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="dswx_s1_final_1.2_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="dswx_s1_final_1.2_runconfig.yaml"

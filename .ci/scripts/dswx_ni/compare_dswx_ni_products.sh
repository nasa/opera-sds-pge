...
# DSWx-NI products. Each individual pair of products is compared using the
# dswx_ni_compare.py script.
...
echo $overall_status > $OUTPUT_DIR/"compare_dswx_ni_products.rc"

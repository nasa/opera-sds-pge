...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="dswx_ni_interface_0.1_expected_input.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="dswx_ni_interface_0.1_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_dswx_ni_delivery_0.1_interface_runconfig.yaml"

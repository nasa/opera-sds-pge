...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="dswx_ni_calval_0.4.1_expected_input.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="dswx_ni_calval_0.4.1_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_dswx_ni_r4.1_calval_runconfig.yaml"
...
algo_runconfig="opera_pge_dswx_ni_r4.1_calval_algorithm_parameters.yaml"

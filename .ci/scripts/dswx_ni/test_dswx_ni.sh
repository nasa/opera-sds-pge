#!/bin/bash
# Script to execute unit tests on the OPERA DSWx-NI PGE Docker image
...
Testing DSWx-NI PGE Docker image...
...
CONTAINER_HOME="/home/dswx_user"
CONDA_ROOT="/home/dswx_user/miniconda3"
...
ENTRYPOINT="run --no-capture-output -n DSWX-SAR ${CONDA_ROOT}/bin/pge_tests_entrypoint.sh"

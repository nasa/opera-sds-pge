...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="tropo_final_1.0_expected_input.zip "
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="tropo_final_1.0_expected_output.zip "
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_tropo_1.0_final_runconfig.yaml"

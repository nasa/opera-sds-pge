...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="disp_s1_r6.11_final_expected_input.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="disp_s1_r6.11_final_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_disp_s1_r6.11_final_runconfig_forward.yaml"
...
echo "Testing DISP-S1 Baseline Workflow(s)"
...
historical_runconfig="opera_pge_disp_s1_r6.11_final_runconfig_historical.yaml"
...
do
    ...
    algo_runconfig="opera_pge_disp_s1_r6.11_final_algorithm_parameters_${mode}.yaml"
    ...
    docker run --rm -u $UID:"$(id -g)" --name $container_name \
               ...
               ${PGE_IMAGE}:"${PGE_TAG}" --file /home/mamba/runconfig/opera_pge_disp_s1_r6.11_final_runconfig_${mode}.yaml
...
INPUT_DATA="disp_s1_static_r6.11_final_expected_input.zip"
EXPECTED_DATA="disp_s1_static_r6.11_final_expected_output.zip"
RUNCONFIG="opera_pge_disp_s1_static_r6.11_final_runconfig.yaml"
...
docker run --rm -u $UID:"$(id -g)" --name $container_name \
           ...
           ${PGE_IMAGE}:"${PGE_TAG}" --file /home/mamba/runconfig/opera_pge_disp_s1_static_r6.11_final_runconfig.yaml

...
Building CAL-DISP PGE docker image...
...
[ -z "${TAG}" ] && TAG="${USER}-dev"
[ -z "${SAS_IMAGE}" ] && SAS_IMAGE="artifactory-fn.jpl.nasa.gov:16001/gov/nasa/jpl/opera/adt/opera/cal-disp:interface_0.1"
...
echo "CAL-DISP PGE Docker image build complete"

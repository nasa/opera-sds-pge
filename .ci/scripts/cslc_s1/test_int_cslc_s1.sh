...
[ -z "${INPUT_DATA}" ] && INPUT_DATA="cslc_s1_final_0.5.6_expected_input_data.zip"
[ -z "${EXPECTED_DATA}" ] && EXPECTED_DATA="cslc_s1_final_0.5.6_expected_output.zip"
[ -z "${RUNCONFIG}" ] && RUNCONFIG="opera_pge_cslc_s1_delivery_6.5_final_runconfig.yaml"
...
static_runconfig="opera_pge_cslc_s1_static_delivery_6.5_final_runconfig.yaml"

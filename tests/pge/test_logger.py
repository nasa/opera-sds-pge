...
from opera.util.error_codes import (
    CODES_PER_RANGE,
...
class LoggerTestCase(unittest.TestCase):
    ...
    def test_pge_logger(self):
        ...
        self.assertEqual(
            str(self.logger.start_time), re.match(self.monotonic_regex, str(self.logger.start_time)).group()
        )
        ...
        self.arg_test_logger = PgeLogger(
            workflow="test_pge_args", error_code_base=17171717, log_filename="test_args.log"
        )
    ...
    def add_backframe(self, back_frames):
        ...
        self.logger.log_one_metric(
            "test_logger.py",
            "Test log_one_metric(): log from method call (back_frames = 0)",
            18,
            additional_back_frames=back_frames,
        )
    ...
    def one_deeper(self, back_frames):
        ...
        self.logger.log_one_metric(
            "test_logger.py",
            "Test log_one_metric(): log called from 2 method calls (no bf)",
            19,
            additional_back_frames=back_frames,
        )
